...
const Users = () => {
    ...
    const userQuery = useQuery({
        ...
        enabled: Boolean(user && debouncedUsername),
    });


    const repositoriesQuery = useQuery({
        queryKey: ["github-repositories", debouncedUsername],
        queryFn: () => fetchGithubRepositories(debouncedUsername),
        enabled: Boolean(user && debouncedUsername),
    });
    ...
    const loading = userQuery.isLoading || repositoriesQuery.isLoading;
